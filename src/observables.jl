...
"""
    calc_average_plaquette(param, Us::Array{T, 6}) where T

Calculate average plaquette for gauge fields in 5 dimension.
"""
function calc_average_plaquette(param, Us::Array{T, 6}) where T
    @unpack Nsite = param
    ...
    for ν in 1:5, μ in 1:ν-1, n₅ in 1:Nsite, n₄ in 1:Nsite, n₃ in 1:Nsite, n₂ in 1:Nsite, n₁ in 1:Nsite
        U = calc_plaquette(Us, n₁, n₂, n₃, n₄, n₅, μ, ν)
        P += 1 - real(tr(U))/Nc
    end
    P /= 10*Nsite^5
    return P
