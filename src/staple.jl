...
function calc_staple(U_zero, Us, n₁, n₂, μ)
    ...
    for ν in 1:2
        ...
        U₁ = inv(Us[f(n₁+δ(1,μ)-δ(1,ν)), f(n₂+δ(2,μ)-δ(2,ν)), ν])
        U₂ = inv(Us[f(n₁-δ(1,ν)), f(n₂-δ(2,ν)), μ])
...
function calc_staple(U_zero, Us, n₁, n₂, n₃, n₄, μ)
    ...
    for ν in 1:4
        ...
        U₁ = inv(Us[f(n₁+δ(1,μ)-δ(1,ν)), f(n₂+δ(2,μ)-δ(2,ν)), f(n₃+δ(3,μ)-δ(3,ν)), f(n₄+δ(4,μ)-δ(4,ν)), ν])
        U₂ = inv(Us[f(n₁-δ(1,ν)), f(n₂-δ(2,ν)), f(n₃-δ(3,ν)), f(n₄-δ(4,ν)), μ])
...
function calc_staple(U_zero, Us, n₁, n₂, n₃, n₄, n₅, μ)
    ...
    for ν in 1:5
        ...
        U₂ = inv(Us[f(n₁+δ(1,ν)), f(n₂+δ(2,ν)), f(n₃+δ(3,ν)), f(n₄+δ(4,ν)), f(n₅+δ(5,ν)), μ])
        U₃ = inv(Us[n₁, n₂, n₃, n₄, n₅, ν])
        U_staple += U₁*U₂*U₃
        
        U₁ = inv(Us[f(n₁+δ(1,μ)-δ(1,ν)), f(n₂+δ(2,μ)-δ(2,ν)), f(n₃+δ(3,μ)-δ(3,ν)), f(n₄+δ(4,μ)-δ(4,ν)), f(n₅+δ(5,μ)-δ(5,ν)), ν])
        U₂ = inv(Us[f(n₁-δ(1,ν)), f(n₂-δ(2,ν)), f(n₃-δ(3,ν)), f(n₄-δ(4,ν)), f(n₅-δ(5,ν)), μ])
